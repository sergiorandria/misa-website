  ...
  return (
    <div className="bg-white">
      <div className="max-w-[1160px] mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="text-[11px] sm:text-xs tracking-widest text-neutral-500 font-semibold uppercase">FORMATION — ARBORESCENCE</div>
        <h1 className="mt-2 text-2xl sm:text-3xl font-bold tracking-tight text-[var(--color-misa-ink)]">Arborescence LMD</h1>
        <p className="mt-2 sm:mt-3 max-w-[720px] text-xs sm:text-sm text-neutral-600 leading-relaxed">
          Reproduction fidèle du schéma officiel <span className="font-mono text-[11px] bg-[var(--color-misa-paper)] border border-[var(--color-misa-line)] px-1.5 py-0.5">MIT(1).png</span> de mit.univ-antananarivo.mg. Les informations ci-dessous reprennent uniquement ce qui est lisible sur le site — aucun intitulé n’a été inventé.
        </p>
        <p className="mt-2 text-[11px] sm:text-xs text-neutral-500 flex items-center gap-1">
          <FileText size={13} className="text-neutral-400 shrink-0" />
          <span>Source originale : <code> /assets/images/MIT(1).png</code> — image incluse en bas de page pour vérification.</span>
        </p>
      </div>

      <div className="max-w-[1160px] mx-auto px-4 sm:px-6 pb-12">
        {/* LMD Academic Progression Tree */}
        <div className="border border-[var(--color-misa-line)] bg-white shadow-xs">
          {/* L1 */}
          <div className="grid md:grid-cols-[200px_1fr] border-b border-[var(--color-misa-line)]">
            <div className="bg-[var(--color-misa-paper)] p-4 sm:p-5 border-b md:border-b-0 md:border-r border-[var(--color-misa-line)] flex flex-col justify-center">
              ...
              <div className="font-bold text-sm sm:text-base mt-1 text-[var(--color-misa-ink)]">Informatique et Technologie</div>
            </div>
            <div className="p-4 sm:p-5">
              <div className="text-[11px] sm:text-xs tracking-widest text-neutral-500 font-semibold uppercase">MODALITÉ D’ACCÈS</div>
          ...
          <div className="grid md:grid-cols-[200px_1fr] border-b border-[var(--color-misa-line)]">
            <div className="bg-[var(--color-misa-paper)] p-4 sm:p-5 border-b md:border-b-0 md:border-r border-[var(--color-misa-line)] flex flex-col justify-center">
              ...
              <div className="font-bold text-sm sm:text-base mt-1 text-[var(--color-misa-ink)]">MISA</div>
              <div className="text-[11px] text-neutral-500 mt-0.5">Mathématiques, Informatique et Statistique Appliquées</div>
            </div>
            <div className="p-4 sm:p-5">
              <div className="text-[11px] sm:text-xs tracking-widest text-neutral-500 font-semibold uppercase">MODALITÉ D’ACCÈS</div>
              <ul className="mt-2 text-xs sm:text-sm leading-relaxed list-disc pl-5 space-y-1 text-neutral-700">
          ...
          <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-[var(--color-misa-line)] border-b border-[var(--color-misa-line)]">
            <div className="p-4 sm:p-5">
              ...
              <div className="text-[11px] sm:text-xs tracking-widest text-neutral-500 font-semibold uppercase mt-3">MODALITÉ D’ACCÈS</div>
              <ul className="mt-2 text-xs sm:text-sm leading-relaxed list-disc pl-5 space-y-1 text-neutral-700">
        ...
        <div className="mt-8 border border-[var(--color-misa-line)] p-4 sm:p-5 bg-[var(--color-misa-paper)] shadow-xs">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
              <div className="text-[11px] sm:text-xs tracking-widest text-neutral-500 font-semibold uppercase">IMAGE SOURCE — VÉRIFICATION</div>
            ...
            <button
              ...
              className="min-h-[44px] flex items-center justify-center gap-2 bg-white border border-[var(--color-misa-ink)] text-[var(--color-misa-ink)] text-xs font-semibold px-4 py-2 hover:bg-[var(--color-misa-ink)] hover:text-white transition cursor-pointer shrink-0"
            >
              <ZoomIn size={16} />
          ...
          >
            ...
            <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 flex items-center justify-center transition">
              <span className="bg-white text-[var(--color-misa-ink)] font-semibold text-xs px-3 py-2 border border-neutral-300 shadow-md flex items-center gap-2">
                <ZoomIn size={14} /> Touchez pour faire un zoom plein écran
              </span>
            </div>
          </div>
        </div>
      ...
      {/* Lightbox / Zoom Modal */}
      {modalOpen && (
        <div className="fixed inset-0 z-50 bg-black/90 p-4 sm:p-6 flex flex-col justify-between backdrop-blur-md animate-in fade-in duration-200">
          <div className="flex items-center justify-between text-white border-b border-white/20 pb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="min-h-[38px] min-w-[38px] flex items-center justify-center bg-white/20 hover:bg-white/30 text-white transition cursor-pointer"
                aria-label="Fermer"
              >
                <X size={20} />
              </button>
