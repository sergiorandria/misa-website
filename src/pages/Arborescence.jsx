        ...
        <div className="border border-[var(--color-misa-line)]">
          ...
          <div className="grid md:grid-cols-[200px_1fr] border-b border-[var(--color-misa-line)]">
            <div className="bg-[var(--color-misa-paper)] p-6 border-b md:border-b-0 md:border-r border-[var(--color-misa-line)]">
              ...
              <div className="font-bold mt-2">Informatique et Technologie</div>
            </div>
            <div className="p-6">
          ...
          <div className="grid md:grid-cols-[200px_1fr] border-b border-[var(--color-misa-line)]">
            <div className="bg-[var(--color-misa-paper)] p-6 border-b md:border-b-0 md:border-r border-[var(--color-misa-line)]">
              ...
              <div className="font-bold mt-2">MISA</div>
          ...
          <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-[var(--color-misa-line)] border-b border-[var(--color-misa-line)]">
            <div className="p-6">
              ...
              <div className="text-xs tracking-widest text-neutral-500 mt-4">MODALITÉ D'ACCÈS</div>
              <ul className="mt-3 text-sm leading-relaxed list-disc pl-5 space-y-1">
